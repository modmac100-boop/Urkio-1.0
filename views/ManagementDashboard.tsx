...
const ManagementDashboard: React.FC<Props> = ({ navigate, role }) => {
      ...
      <header className="sticky top-0 z-50 bg-[#050b1a]/90 backdrop-blur-xl p-6 border-b border-white/5 flex items-center justify-between">
        <div className="flex items-center gap-4">
           <div className={`size-10 rounded-xl flex items-center justify-center border ${
             isBoard ? 'bg-amber-500/20 text-amber-500 border-amber-500/20' : 'bg-primary/20 text-primary border border-primary/20'
           }`}>
