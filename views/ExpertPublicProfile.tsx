          ...
          <div className="flex items-center gap-3">
            ...
            {isOwnProfile ? (
              ...
              <button 
                ...
                className={`h-11 px-6 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all active:scale-95 shadow-xl ${
                  isFollowing ? 'bg-emerald-500 text-white' : `${themeGradient} text-white ${themeShadow}`
                }`}
              >
                 <div className="flex items-center gap-2">
