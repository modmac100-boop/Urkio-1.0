           ...
           <div className="grid grid-cols-2 gap-3">
              {STUDY_LEVELS.map(level => (
                <button 
                  ...
                  className={`px-4 py-3 rounded-2xl text-[9px] font-black uppercase text-start border transition-all active:scale-95 ${
        ...
        <div className="fixed inset-0 z-[200] bg-background-dark flex items-center justify-center animate-in fade-in duration-300">
           <div className="text-center px-10 animate-in zoom-in duration-300">
              ...
              <h3 className="text-xl font-black mb-2 text-white">
                 {language === 'en' ? 'تغيير لغة النظام' : 'Switching Region'}
              </h3>
              <p className="text-xs text-slate-500 uppercase tracking-widest font-bold">
                 {language === 'en' ? 'يتم الآن تفعيل النسخة العربية...' : 'Initializing English Edition...'}
              </p>
           </div>
        </div>
      )}
