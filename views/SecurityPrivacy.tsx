...
const SecurityPrivacy: React.FC<Props> = ({ navigate, goBack, language }) => {
   ...
   const t = language === 'ar' ? {
      ...
      header: 'Sécurité & Confid.',
      subHeader: 'Protégez votre parcours',
      accountSec: 'Sécurité du compte',
      visibility: 'Visibilité & Données',
      critical: 'Actions critiques',
      tfa: 'Auth à deux facteurs',
      tfaActive: 'Active',
      tfaInactive: 'Non protégée',
      biometrics: 'Connexion biométrique',
      biometricsDesc: 'FaceID / Empreinte',
      public: 'Profil public',
      publicDesc: 'Visible pour les membres',
      homii: 'Partage Homii',
      homiiDesc: 'Accès pour l\'examen d\'expert',
      incognito: 'Mode Incognito',
      incognitoDesc: 'Interactions anonymes',
      export: 'Exporter mes données',
      exportDesc: 'Historique clinique JSON',
      purge: 'Supprimer le compte',
      purgeDesc: 'Suppression définitive',
      grade: 'Qualité médicale',
      gradeDesc: 'Urkio utilise des cryptages conformes HIPAA. Vos réflexions vocales et données cliniques ne regardent que vous et votre spécialiste.'
   } : {
