        ...
        {!profileComplete && (
          <section className="animate-in fade-in slide-in-from-top-4 duration-700">
             <div 
               ...
               className={`relative overflow-hidden bg-slate-900 border-2 rounded-[2.5rem] p-8 shadow-2xl group cursor-pointer active:scale-[0.98] transition-all ${
                 isDietitian ? 'border-urkio-green/40' : 'border-primary/30'
               }`}
             >
                ...
                <div className="relative z-10 space-y-6">
                   ...
                   <button className={`w-full h-12 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-xl group-hover:scale-[1.02] transition-transform ${
                     isDietitian ? 'bg-urkio-green text-slate-900' : 'bg-white text-slate-900'
                   }`}>
